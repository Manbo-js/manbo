 ...
 * @porp {Object} defaultReactionEmoji The default emoji to show in the add reaction button on a thread
 ...
 * @prop {Number} flags Channel flagss for this channel
...
class ForumChannel extends GuildChannel {
    ...
    createThread(options) {
        return this.client.createGuildForumThread.call(this.client, this.id, options);
    }
