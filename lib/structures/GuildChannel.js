...
class GuildChannel extends Channel {
    ...
    * @arg {Object} [options.defaultReactionEmoji] The default emoji to show as reaction button (forum channels only)
...
const ThreadChannel = require("./ThreadChannel");const ForumChannel = require("./ForumChannel");
