...
/**
 * Represents an Manboo client with the command framework
 * @extends Client
...
class CommandClient extends Client {
     ...
     * @arg {Object} options Manboo options (same as Client)
     ...
     * @arg {String} [commandOptions.description="An Manboo-based Discord bot"] The description to show in the default help command
        ...
        this.commandOptions = Object.assign(
            {
                ...
                description: "An Manboo-based Discord bot",
                ignoreBots: true,
                ignoreSelf: true,
                name: null,
