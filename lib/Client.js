...
class Client extends EventEmitter {
    ...
    createChannel(guildID, name, type, reason, options = {}) {
        ...
        return this.requestHandler.request("POST", Endpoints.GUILD_CHANNELS(guildID), true, {
            ...
            default_reaction_emoji: options.defaultReactionEmoji ?
                {emoji_id: options.defaultReactionEmoji.id, emoji_name: options.defaultReactionEmoji.name}
    ...
    createGuildForumThread(channelID, options) {
        ...
        if(options.message !== undefined) {
            if(options.message.allowedMentions) {
                options.message.allowedMentions = this._formatAllowedMentions(options.message.allowedMentions);
            }
        ...
        return this.requestHandler.request("POST", Endpoints.THREAD_IN_FORUM(channelID), true, {
    ...
    */  
    async editGuildMFALevel(guildID, options) {
        return this.requestHandler.request("POST", Endpoints.GUILD_MFA(guildID), true, options);
    }
