...
class Client extends EventEmitter {
    ...
    */
     ...
     * @arg {Boolean} [options.mfaLevel] The guild mfa level to set, either 0 (None) or 1 (Elevated)
     * @arg {String?} [options.reason] The reason to be displayed in audit logs
     * @returns {Promise<Number>}
     */
    async editGuildMFALevel(guildID, options) {
        return this.requestHandler.request("POST", Endpoints.GUILD_MFA(guildID), true, {
            level: options.mfaLevel,
            reason: options.reason
        });
    }
